     ...
     */
     ...
     if( isset($val) ) {
         if( trim($val)=="" ) {
             ...
             $e_mail_user=mysql_result($res_select,0,1);         
           ...
           if( intval($lnerro)<1 ) {
                  /************************************************************
                    ...
                    **********************************************************/
                    ...
                    ///
                   ///  Enviando email para o Administrador/Supervisor
...
/***                   
   echo "ERRO: srv_removerusuario/453  --  \$confirmar0 = $confirmar0  --- \$_SESSION[res_mail] = {$_SESSION["res_mail"]} ";
   exit();                   
    ***/               
                   if( $_SESSION["res_mail"] ) {
                       $confirmar0 .=$_SESSION["res_mail"];
                   }  else {
                       $confirmar0 .="<br>ERRO: Ocorreu um erro durante o envio do email.<br><br>";
                   }           
                   echo $confirmar0;        
                   ////  
           }
...
/**     
   echo "ERRO: srv_removerusuario/453  --  \$confirmar0 = $confirmar0  --- \$_SESSION[res_mail] = {$_SESSION["res_mail"]} ";
***/
    echo "ERRO: srv_removerusuario/453  -- \$string_cip = $string_cip --- \$dir_proj_total = $dir_proj_total   <<<----   \$autor_projeto_cod = $autor_projeto_cod  ";
    exit();                   
   ...
   echo $funcoes->mostra_msg_ok("<p class='titulo_usp' >O usuário $autor_projeto_nome foi removido$texto_complementar.</p>");
