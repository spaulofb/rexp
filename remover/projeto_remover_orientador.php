...
///
?> 
<div  id="inicio_pagina_cab" style="display: flex;"  >
 <div class='titulo_usp' style='margin-left: 40%; padding:2px 0 2px 2px; vertical-align: bottom;font-weight: bold;font-size:large;  '>
   Mostrar:&nbsp;
...
<p class="titulo_usp2" >Selecionar:</p>
</div>
<div style="text-align: center;padding-top:0px; padding-bottom: 5px;" >
<select  name="busca_proj" id="busca_proj"  title="Selecione o Projeto" onchange="javascript:  remove_projeto('busca_proj',this.value)"  >
...
<p class='titulo_usp2' >Lista dos Projetos</p>
<!-- Tabela dos Projetos  -->
