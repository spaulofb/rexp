...
/***    $font_size_family="font-size: x-small; font-family: Arial, Helvetica, Times, Courier, Georgia, monospace; ";
    ...
    ***/
    ...
    $campos_fora=array("ARQUIVO","DATA","PROJETO_TITULO","AUTOR","PROJETO_AUTOR","ALTERA","ALTERADA","ANOTADORCOD");
    ...
    for($column_num = 0; $column_num < $num_fields; $column_num++) {
            ...
            echo "<th  class='font_size_family'  "
                ." style='text-align: $text_align; background-color: #00FF00; border: 1px solid #000000; ' >"
