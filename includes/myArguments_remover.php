...
function Init(nome,valor) {
   ...
   if( valor.toUpperCase()=="EXCLUIR" ) {
           poststr +="source=EXCLUIR&val="+m_val;           
   }

   
//  alert(" LINHA 60 - arq myArguments_remover.php - poststr = "+poststr)   
   ...
   //  exemplo: projeto_remover_ajax.php
   var receber_dados = opcao.toLowerCase()+"_remover_ajax.php";
   //
    var inclusao = function (oXML) { 
             ...
             //     alert("  LINHA  68  -- m_dados_recebidos =  "+m_dados_recebidos)                          
                     if( opcao=="CONJUNTO" ) { 
                         ...
                         if( cpo_ant.toUpperCase()=="INSTITUICAO" ) limpar_campos(new_elements);
                         ...
                         if( prox_cpo.length ) {
                              ...
                              if( pos != -1 )  {
                                  if( lsinstituicao  == -1 )  {
                                        ...
                                        mensg_erro(m_dados_recebidos,"erro_remover");
