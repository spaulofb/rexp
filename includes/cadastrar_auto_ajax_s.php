  ...
  /*      
    ...
    */
       ...
       if( ! $result_usu ) {
           ...
           die('ERRO: SELECT usuario/orientador: '.mysql_error());
           exit();  
       }
       $n_regs = 0;
       ...
       /*   $result_login = mysqli_query("SELECT a.login,a.aprovado,b.nome  FROM  usuario where "
         ...
         */ 
          ...
          if ( ! $result_login ) {
                ...
                $msg_erro .= "&nbsp;Usu&aacute;rio/Login:&nbsp;".$login." - falha no mysql/query:".mysql_error().$msg_final;
                echo $msg_erro;
                exit();
          }
          $m_regs = mysql_num_rows($result_login);
          if(  $m_regs>=1 ) {
