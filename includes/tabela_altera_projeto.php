    ...
    ***/   
    ...
    for( $i = 0;$i<$num_fields; $i++) { //  Pega o nome dos campos
     ...
     if( ! $result_max_length ) {
         /// die('ERRO: Select maximo tamanho dos campos da tabela  table_alterar_projeto - falha: '.mysqli_error($_SESSION["conex"]));
          $msg_erro .= "&nbsp;Select maximo tamanho dos campos da tabela  $table_alterar_projeto - falha:&nbsp;db/mysql&nbsp;".mysqli_error($_SESSION["conex"]);
    ...
    echo "<TABLE style='width: 100%; margin-left: 3px;' cellpadding='1' cellspacing='2' >";
    echo "<tr>";
