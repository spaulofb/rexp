...
<div class="menu_principal"  id="menu_principal" style="z-index:99;position: relative; top: 38px;"  >
<ul class="otimizacaositesbusca otimizacaositesbuscam"  style="float:right; width: 99%; height: 26px;" >
   <?php
      $m_horiz = "";
