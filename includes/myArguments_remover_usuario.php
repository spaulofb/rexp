...
function Init(nome,valor) {
   ...
   } else if( nome.toUpperCase()=="USUARIO" ) {
       var opcao = "usuario"; var m_val = "usuario";
   } else if( nome.toUpperCase()=="PROJETO" ) {
       var opcao = "projeto"; var m_val = "projeto";
   }  
   if(  nome!=undefined ) {
     if( nome.toUpperCase()=="USUARIO" &&  valor.toUpperCase()=="EXCLUIR"   ) {  
           var opcao="EXCLUIR"; 
   ...
   var receber_dados = "usuario_remover_ajax.php";
   
//  alert("  myArguments_remover_usuario.php/84 - poststr = "+poststr+" - opcao =  "+opcao+" - receber_dados =  "+receber_dados)   
   ...
   // Iniciando function
    var inclusao = function (oXML) { 
             ...
             //     alert("  LINHA  68  -- m_dados_recebidos =  "+m_dados_recebidos)                          
                     if( opcao=="USUARIO" ) {                             
                            //  USUARIO pode ser Orientador e  Anotador

    //  alert("LINHA 144 - arq myArguments_remover.php -  USUARIO -  m_dados_recebidos = "+m_dados_recebidos)
                          ...
                          //  Depois de ter excluido um Usuario e seus Projetos
