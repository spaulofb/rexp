         ...
         //   if( strtoupper($field_name)=='ARQUIVADO_COMO' ) {
            ...
            if( preg_match("/ITULO|DATA/i",$field_name_upper) ) {
               ...
               // $valor = substr($valor,strpos($valor,"_")+1,strlen(trim($valor)));
                ...
                ?>                        
                <td id="tr_itemOn" class="itemOn" onmouseover="javascript: mouse_over_menu(this);"  onmouseout="javascript: mouse_out_menu(this);"   style="text-align: left; white-space:nowrap; font-weight: bold; border: 1px solid #000000; <?php echo $font_size_family;?> ">
                <?php
                ...
                <?php
                  $cmdhtml2 = "<a href='#' onclick='javascript: consulta_mostraanot(\"DETALHES\",\"$valor\",\"$usuario_conectado#anotacao\");return true;'  "
