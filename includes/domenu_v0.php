 ...
 ///  alert("domenu/58  --- INICIANDO  --- source = "+source+" -  val  = "+val+"   ---  m_array = "+m_array);
    ...
    if( typeof(source)=='string' ) {
        ...
        ///
          ...
          source = source.value;                
    //  } else if(source instanceof Array) {  //  Antigo
    } else if (Array.isArray(source)) {  // O jeito moderno e seguro
          //
...
/**
 *       alert("  domenu.php/71  --->> raiz_central = "+raiz_central+"  --- source = "+source
*            +" - val = "+val+"  -- m_array = "+m_array
 *           +"  -- source_maiusc =  "+source_maiusc+"\r\n  navegador_usado = "+navegador_usado); 
 */
...
/**
*    alert(" domenu.php/274 -->> pos = "+pos+"  -->>  login_down = "+ login_down+"  --  senha_down = "
*          + senha_down+" --  source = "+source+"  -- val = "+val+" ---  raiz_central = "+raiz_central
...
*/
    ...
    poststr +="&login="+encodeURIComponent(login_down)+"&senha="+encodeURIComponent(senha_down);
    poststr +="&m_array="+encodeURIComponent(m_array);
    //


  //  alert("domenu.php - LINHA/343 - poststr = "+poststr);
    ...
    var inclusao = function (oXML) { 
                     ...
                     //
                     // Caso houver Erro 
                     var pos = dados_recebidos.search(/ERRO:|FALHA:/ui);

  /**
  *   alert(" domenu/312 -> pos = "+pos+" --inclusao--  raiz_central = "+raiz_central+" -- source_sem_acentos = "
  *              +source_sem_acentos+" - val = "+val+"  \r\n dados_recebidos = "+dados_recebidos);                         
  */                     
                     ...
                     if( source_sem_acentos.toUpperCase()=="SAIR" ) {
                          ...
                          */
                          ...
                          if( is_firefox!=-1 ) {
                              ...
                              //
                              // 20260429 - Melhor opcao para  sair do Chrome
                              parent.location.href=raiz_central+"reiniciar.php";
                              //
                              window.open('', '_self', ''); // bug fix
                              window.close();            
               ...
               //
            /**  
            *  Enviado dados para pagina AJAX
           ...
           /**   Nesse script se o usuario não tiver suporte a JavaScript  
            *    porisso eu coloquei return false no form o php enviar sozinho   
           */
}
/**   Final - function dochange(source,val,m_array)  {   */
//
