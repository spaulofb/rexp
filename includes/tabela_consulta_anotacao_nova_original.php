        ...
        for( $column_num=0; $column_num<$num_fields; $column_num++) {
            ...
            if( $field_name_upper=='TITULO' ) {
               ...
               ///   $titulo=$linha[$column_num];
                ...
                echo "<td  id=\"tr_itemOn\" class=\"itemOn\" onmouseover=\"javascript: mouse_over_menu(this);\"  
                ...
                if(  in_array($field_name_upper,$ar_cps_final_tab)  ) {
                    ...
                    $_SESSION["nr"]= (int) mysql_result($query,$conta_linha,"nr");
...
//  echo "<hr style='border-bottom: 1px solid #f00; color: #000000; background-color: #ffffff;  height: 4px; '  >";
