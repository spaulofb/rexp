...
///
///  Verifica se a SESSION titulo_cabecalho existe
if( isset($_SESSION["titulo_cabecalho"]) ) {
     $titulo_cabecalho=$_SESSION["titulo_cabecalho"];
} else {
     $msg_erro .= "Sessão titulo_cabecalho não está ativa. Corrigir".$msg_final;  
     echo $msg_erro;
     exit();
}
///
