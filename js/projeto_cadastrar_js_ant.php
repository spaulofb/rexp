...
/**     
 alert(" projeto_cadastrar_js/237  -->>  INICIO (0) pagina_local = "+pagina_local+"  --->> raiz_central = "+raiz_central
        ...
        case "SUBMETER": 
             ...
             */
             ...
             for( wq=0; wq<m_elements_total; wq++ ) {
                  ...
                  //
                  if( m_id_type.toUpperCase()=="TEXTAREA" ) {
                       //
                       var elmid = frm.elements[wq].id;
                       var idelm = document.getElementById(elmid);
                       var val = trim(idelm.value);
                       //
                      
                       /**
                       *  alert("1)  val = "+val+" -->>  elmid = "+elmid+" -->> val length =  "+val.length);
                       */
                       
                       //   alert(" val = ");
                       if( val<1 ) {
                            //
                           var mensag_erro="Faltando digitar o Título do Projeto - Corrigir.";
                           //
                           setTimeout(() => {
                                 //
                  ...
                  /**  Final - if( m_id_type.toUpperCase()=="TEXTAREA" ) {  */
                  //
 ...
 ////  alert("LINHA/202 ///DENTRO\\\  "+zx+"  -->>>> total_de_datas = "+total_de_datas+" - "+m_id_name+" - "+m_id_value);
     ...
     alert("LINHA 526 -->> m_id_name = "+m_id_name+" - m_id_value = "+m_id_value+" -  m_id_type = "+m_id_type+" - m_erro = "+m_erro+"\r\n\r\n"+testecponv)            
                                 */
...
/**     
    alert(" projeto_cadastrar_js/521  -->>> pos = "+pos+" <--> receber_dados = "+receber_dados
