...
//// alert(" anotador_cadastrar_js/132 -  source = "+opcao+" -- val = "+val+"  -  string_array ="+string_array+" \r\n quantidade = "+quantidade);
 ...
 ///   alert(" anotador_cadastrar_js.php/493 -->> INCLUSAO --  pos = "+pos+"  --- opcao = "+opcao+" - val = "+val+" -  \r\n m_dados_recebidos =  "+m_dados_recebidos);
