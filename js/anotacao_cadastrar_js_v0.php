...
function enviar_dados_cad(source,val,m_array) {
 ...
 /// alert(" anotacao_cadastrar_js/55  -- INICIO - source = "+source+"  --  val = "+val);
 ...
 ////  alert(" anotacao_cadastrar_js.php/104 -  source = "+opcao+" -- val = "+val+" -  m_array = "+m_array);
			 ...
			 if( m_id_type=="checkbox" ) {
                 ...
                 if( ! elements[i].checked ) var m_erro = 1;
				  ...
				  if( m_id_value=="" ) {
                     ...
                     }  ///  FINAL - IF  CORESPONSAVEIS ou  COLABS 
                     ///
                     if( m_erro<1  ) {
...
////     alert(" anotacao_cadastrar_js/364 -  source = "+opcao+" -- val = "+val+" -  m_array = "+m_array+" \r\n\n m_dados_recebidos =  "+m_dados_recebidos);                         
