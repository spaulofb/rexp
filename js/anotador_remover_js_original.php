<?php
//
// Verificando conexao  - PARA REMOVER - PROJETO/ANOTADOR  -  js
//
...
/*
     JavaScript Document  - 20180612
     - arquivo anotador_remover_js.php
*******************************************************/
/****  
...
///
///    Function para receber dados - AJAX
function enviar_dados_anotador(source,val,string_array) {
...
///  alert(" anotador_remover_js/132 -->> INICIO <<--  source = "+opcao+" -- val = "+val+"  -  string_array ="+string_array);
     ...
     ***/
     ...
     var quantidade=opcao.search(/PROJETO|RESET/i);
     if( quantidade!=-1 ) {
         var retornar=0;
         if( opcao=="PROJETO" ) {
 ...
 ///   alert(" anotador_remover_js/198 --\\\   source = "+opcao+" -- val = "+val+"  -  string_array ="+string_array);
	 ...
	 if( opcao=="SUBMETER" ) {
        ...
        //// alert("cpo#"+i+"  nome="+m_id_name+"  tipo="+m_id_type+"  valor="+m_id_value)
			   ...
			   if( m_id_type=="checkbox" ) {
                  ...
                  /****
                  *     Caso id da tag Select for sel_anotador alteral para codigousp do Anotador
                  *        alterado em 20180518
                  ***/
                  if( m_id_name.toUpperCase()=="SEL_ANOTADOR" ) {
                        m_id_name="codigousp";  
                        var anotador_codigousp="codigousp"; 
                  } 
                 ///
  ...
  ///  alert("  anotador_remover_js/399  --  SUBMETER  <<<---   cpo#"+i+"  nome="+m_id_name+"  tipo="+m_id_type+"  valor="+m_id_value);             
 ...
 ////     alert(" CODIGOUSP -  anotador_remover_js/414 -  source = "+opcao+" -- opcao = "+opcao+"  --  val = "+val+" \r\n - poststr =  "+poststr);
   ...
   //   ARQUIVO abaixo onde recebe os DADOS da PAGINA e EXECUTA os procedimentos e Retorna resultado
    ...
    var receber_dados = "anotador_remover_ajax.php";
...
///  alert(" anotador_remover_js.php/359 - opcao = "+opcao+" - val = "+val+" -  \r\n m_dados_recebidos =  "+m_dados_recebidos) ;                        
                      ...
                      if( opcao=="CODIGOUSP" ) {     
                          ...
                          if( pos!=-1 ) {
                              ...
                              if( array_nome.length>1 ) {
                                  ...
                                  ///  document.getElementById('label_msg_erro').innerHTML=array_nome[0];
                                  ...
                                  if( document.getElementById("div_nome") ) {
                                      ...
                                      ///  document.getElementById("div_nome").innerHTML=array_nome[1];
 ...
 ///  alert(" anotador_remover_js.php/549 --->>>  ANOTADOR  <<<--- opcao = "+opcao+" - val = "+val+" -  \r\n m_dados_recebidos =  "+m_dados_recebidos) ;                                                  
                          ...
                          if( val.toUpperCase()=="CODIGOUSP" ) {  
                           ...
                           /// Ativando o ID codigousp com Anotadores do Projeto 
                           exoc("codigousp",1,m_dados_recebidos);                                  
                           return;
                           //// 
					  } else {
                          ...
                          /// Verifica caso encontrou erro  pos!=-1                          
         		          if( pos!=-1 ) {
						      /// document.getElementById('label_msg_erro').innerHTML=m_dados_recebidos;
                              /// Ativando o ID label_msg_erro com mensagem
                              exoc("label_msg_erro",1,m_dados_recebidos);                                  
        ...
        if( !(tecla >= 48 && tecla <= 57 ) && !( tecla==13  ||  tecla==9 ) ) {
           if( !(tecla >= 96 && tecla <= 105 )  ) {
              /* A propriedade keyCode revela o Código ASCII da tecla pressionada. 
		       ...
		       alert("Apenas NÚMEROS s?o aceitos!");
			   field.focus();
               field.select();
		       return false;
		   }
