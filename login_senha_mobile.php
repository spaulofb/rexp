<?php
/*   Parte do arquivo authent_user.php  --  Mobile
...
<div class="section_inicio" style="margin-left: 0;" >
   <div  class="article_inicio"  style="margin-left: 0;"   >
       <div class="usuario_senha"  style="margin-left: 0;"  >    
          <!--  Digitar  Usuario/EMail -->
            ...
            <div class="usuario_senha" >    
               <!-- Digitar Senha -->
                <label for="userpassword" class="label_campos" >
                      Senha:
                </label>
     ...
     <div  class="article_inicio" >
         ...
         <div class="article_div" >       
            ...
            <input type="reset"  name="novocodigo"  id="novocodigo"  class="botao3d" 
                style="width: auto; font-size:smaller; font-weight: normal; " 
                title="Novo c&oacute;digo"  value="Novo c&oacute;digo"  alt="Novo c&oacute;digo"  
                 onclick="javascript: doaction(this.name); return false;" acesskey="N" />
         </div>          

         <!-- Limpar/Enviar -->
         <div class="limpar_enviar_inicio"  >
            <!-- Limpar -->
            ...
            <!-- Final - Limpar -->                   
            <!-- Enviar -->                   
              <input type="submit"  name="enviar" id="enviar" class="botao3d" 
                  style="width: auto; font-size: small;margin-left: .8em;"  acesskey="E" 
                 value="Enviar"  tabindex="4"  alt="Enviar"  
