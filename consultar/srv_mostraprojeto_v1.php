...
exit();
        ...
        if( ! $drop_result  ) {
            ...
            echo $funcoes->mostra_msg_erro("Removendo a Tabela {$table_consultar_projeto} -&nbsp;db/mysql:&nbsp;".mysqli_error($_SESSION["conex"]));            
            exit();       
        }
        ...
        ***/
        ...
        if( ! $result_consult_projeto ) {
            ...
            echo  $msg_erro.mysqli_error($_SESSION["conex"]).$msg_final; */
             echo $funcoes->mostra_msg_erro("Criando a Tabela  {$table_consultar_projeto}&nbsp;-&nbsp;db/mysql:&nbsp;".mysqli_error($_SESSION["conex"]));                        
             exit();
        }       
        ////
