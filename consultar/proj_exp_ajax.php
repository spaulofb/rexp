...
//
// extract: Importa vari·veis para a tabela de sÌmbolos a partir de um array 
...
if( strtoupper($source)=="SAIR" ) {
    ...
    // Define o tempo m·ximo de execuÁ„o em 0 para as conexıes lentas
    set_time_limit(0);
    ...
    exit();       
	 ...
	 if( $n_cpo<=$cpo_final ) { //  Inicio do IF principal
      ...
      //  mysql_db_query - Esta funcao e obsoleta, nao use esta funcao - Use mysql_select_db() ou mysql_query()
		...
		if( strtoupper($cp_table_atual)=="INSTITUICAO" ) $cp_table_atual="instituiÁ„o";
		if( strtoupper($cp_cpo_where)=="INSTITUICAO" ) $cp_cpo_where="instituiÁ„o";
     ...
     if( strtoupper($val)=="PROJETO"  ) {
          ...
          if( strtoupper($source)=="PROJETO" ) { 
                ...
                if( $x_anotacao<1 ) {
                     ...
                     ?>
                    <label for="select_anotacao"  style="vertical-align:middle;  cursor: pointer; text-align: left; color:#000000;"  title="Selecione AnotaÁ„o" >Anota&ccedil;&atilde;o:&nbsp;</label>
