...
/**
echo "LINHA/163 -->>  \$estilocss = $estilocss <<-->>  authent_user.php  -->>  \$incluir_arq = $incluir_arq  ";
exit();
 */
...
*/
/**  
*     Definindo as  variaveis globais  -  20250508
*
...
/**
alert(" LINHA/288/authent_user.php  -  doaction Inicio  --   teste tcaction = "+tcaction+"  - lcaction =  "
     ...
     switch (lcaction) {
       ...
       case "SUBMIT":
           ...
           if( procedimento=="captcha_criar" ) {
                ...
                poststr+="&procedimento="+encodeURIComponent(procedimento);
               //
           } else {
               //
               ...
               if( document.getElementById("userid") ) {
                ...
                /**  Final - if( m_erro.length>0 ) { */
                //
                //   var m_cod_img = document.getElementById("magica").value;  
                var poststr="login_down="+encodeURIComponent(m_login_down);
                poststr+="&senha_down="+encodeURIComponent(m_senha_down)+"&codigo_down=";
                poststr+=encodeURIComponent(m_confirm)+"&m_onload="+encodeURIComponent(lcaction);
                //   
           ...
           */
           ...
           //
           /**   Parametro identificando o procedimento a ser executado pelo AJAX: */
...
///   alert(" authent_user/470  -- poststr = "+poststr);               
           ...
           var inclusao = function(oXML) { 
                 ///
                 var dados_recebidos =  oXML.responseText;
                 var pos = dados_recebidos.search(/Nenhum|Erro|Falha/ui);  
 ...
 */
                 ...
                 if( procedimento=="captcha_criar" ) {            
                     ...
                     //
                     var pos_iniciar = dados_recebidos.search(/iniciando/ui);
                     //
                     if( pos_iniciar!=-1 ) {
                          //
  ...
  ///// alert("doaction/RESET="+lcaction)  ;
          ...
          */
          ...
          /**   Enviando para pagina receber.php usando metodo post, 
           *     + as variaveis, valores e a funcao   
          */
...
/**   Final - function doaction(tcaction,procedimento)  {   */
//
//  
function pa_selecionado(opcao,valor) {
    ...
    /**
 alert(" function  pa_selecionado(opcao,valor) - INICIO -  ativar_maiusc = "+ativar_maiusc+"  -->> m_teste = "+m_teste);    
 */
    ...
    if( ativar_maiusc=="PA_SELECIONADO" ) {
        //
         ...
         var poststr="opcao="+encodeURIComponent(ativar_maiusc)+"&permit_pa="+encodeURIComponent(valor);
         poststr+="&login_down="+encodeURIComponent(m_login_down)+"&senha_down="+encodeURIComponent(m_senha_down);      
         //
    }
    /**   Final - if( ativar_maiusc=="PA_SELECIONADO" ) {  */
    //
     /**
      *     Criando a classe de conexao AJAX  
     */
...
/**
 *      alert("function  pa_selecionado(opcao,valor) -->> INCLUSAO -->> pos = "+pos+"  -- <br/> dados_recebidos =  "+dados_recebidos);         
 */
    ...
    /**
    *  Enviando dados methodo post,+ as variaveis, valores e informar onde vai atualizar - AJAX
    */
     ///  myConn.connect("receber.php", "POST", poststr, inclusao); 
...
/**   Final - function pa_selecionado(opcao,valor) {  */
//
//  Limpar campos
...
/**  Final - function limpar_campos(tipo) {  */
//
...
function id_conteudo(ativ_desat,mensag,m_dados) {
      ...
      if( document.getElementById("conteudo") ) {
          var xlme=document.getElementById("conteudo");
          ...
          //
          if( ativ_desat=="liga" ) {
               document.getElementById("conteudo").innerHTML=mensag;
          }
          // 
      }
      //
    ...
    /**  Final - if( ativ_desat_upper=="INICIAR" ) {  */	
    //
}
///
</script>
