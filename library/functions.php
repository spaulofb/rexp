...
/***
*          IMPORTANTE
*      Alterado em 20250402
*   function para definir Type/Tipo do campo da Tabela
***/
if( ! function_exists("getTypeField") ) {    
    ///     
    function getTypeField($info) {
          //
          /**  Mapeamento de tipos de dados numéricos para Strings  */
          $tipos_mysql = [
          ...
          if( isset($tipos_mysql[$info]) ) {
              $tipo_campo = $tipos_mysql[$info];   
          }
           //
          return $tipo_campo;
          //
    }
    /**  Final - function getTypeField($info) {  */
    //        
}
/**  Final - if( ! function_exists("getTypeField") ) {  */
//
//
