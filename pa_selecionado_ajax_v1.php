 ...
 * 
 * 
 *      $_SESSION["resto"] = "ERRO:  \$incluir_arq = $incluir_arq";
        echo "ERRO:  linha/195  -->> NOVO  -->>  ".$_SESSION["resto"];
        exit(); 
...
require_once("{$_SESSION["incluir_arq"]}includes/exec_ie_firefox.php");
    ...
    //    ini_set('include_path', '/var/www/cgi-bin/');
        //  
        // 
          /**   include_once("/var/www/cgi-bin/php_include/ajax/includes/exec_ie_firefox.php");   
           *  Deu certo
          */
        //
...
/**
 *    echo "ERRO:  pa_selecionado_ajax/188 -->>  DEPOIS DO include -->>  \$login_down = $login_down <<--"
*     ."  -->>  \$senha_down = $senha_down  -->>  \$permit_pa = $permit_pa "
*        ."<br> -->>  \$stotal = $stotal -->> \$opcao_up = $opcao_up ";   
*        exit();
*/


    echo "ERRO:  linha/199  -->>  ".$_SESSION["resto"];
