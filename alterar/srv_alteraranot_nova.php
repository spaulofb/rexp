...
if( $opcao_maiusc=="DESCARREGAR" or $opcao_maiusc=="SUBSTITUIR"  )  {
   ...
   <table>
    <tr style="border: 1px solid #000000;margin: 0;padding:0;" >
     <td>
     <!-- Arquivo da Anotacao -->
      <div style="padding-top: .3em;border: none;"  >
        <span  style="font-weight: bold; color: #000000;"  >
           Arquivo da Anota&ccedil;&atilde;o:&nbsp;
           </span>
            <!-- Arquivo da Anotacao -->
         <span style="background-color: #FFFFFF; color: #000000;padding:1px 3px 1px 3px;" >
...
if( $opcao_maiusc=="SUBSTITUIR"  )  {
     ...
     if( ! $resultado_anotador_nome ) {
        /* $msg_erro .= "Consultando a tabela pessoa nome do anotador  
             - Falha: ".mysqli_error($_SESSION["conex"]).$msg_final;
             echo $msg_erro; 
        */
        echo $funcoes->mostra_msg_erro("&nbsp;Consultando a Tabela pessoa campo nome do anotador  - db/mysql:&nbsp;".mysqli_error($_SESSION["conex"]));
        exit();        
     } 
