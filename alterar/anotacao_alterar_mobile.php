...
if( isset($_POST['fileframe']) ) {
  ...
  if( isset($_FILES['relatext']['tmp_name']) ) {
    ...
    for( $n=1; $n<3 ; $n++ ) {                
        ///   Mobile
        if( intval($n)==1 ) {
            $_SESSION["dir"] = "/var/www/html".$_SESSION["pr_relatanot"]."doctos_img/A".$projeto_autor;
        }
...
///
/***
*        Configurar igual essas TAGS do HTML5 para Tela - 20180926
*/
?>
<!DOCTYPE html>
<html lang="pt-BR" >
    ...
    <tr>
     <!-- Relatorio Externo (link) Projeto -->
      <td  class="td_inicio1" style="vertical-align: middle;"  colspan="1" >
         <label for="relatext" style="vertical-align: middle; cursor: pointer; " title="link para o Arquivo da Anota??o" >
             Arquivo (link):&nbsp;</label>
        </td  >
     ...
     <tr>
      <!--  Aviso na espera do processo -->
       <td  id="aguarde_arq"  style="text-align: center; background-color: #FFFFFF; color: #000000;;border:2px solid #000000;"   colspan="3" >
