...
// Determina qual op??o do Select <idselecproj> foi selecionada:
  ...
  ////    idselecproj_pos = idselecproj.search(/DESCARREGAR|DETALHES|SUBSTITUIR|SUBMETER/i); 
    ...
    ///
    ///  Enviando os dados para o arquivo AJAX
...
/// alert("cpo#"+i+"  nome="+m_id_name+"  tipo="+m_id_type+"  valor="+frm.elements[i].value)
             ...
             if( m_id_type== "checkbox" ) {
                 ...
                 var m_id_name_upper=m_id_name.toUpperCase();
                  ...
                  if(( m_id_name_upper=="TESTEMUNHA1" ) || ( m_id_name_upper=="TESTEMUNHA2" ) ) {           if( m_id_name.toUpperCase()=="TESTEMUNHA1" ) {
...
/// alert(" anotacao_alterar_nova.php/849 -  lnip =  "+lnip+"  \r\n idselecproj = "+idselecproj+"\r\n\r\n - Recebendo resultado do srv_ret = "+srv_ret);
 
 
          /// Verifica se houve - Nenhum ou ERRO
          if( lnip==-1 ) {
              ///
    ...
    <tr  >
     <!-- Relatorio Externo (link) Projeto -->
      <td  class="td_inicio1" style="vertical-align: middle;"  colspan="1" >
         <label for="relatext" style="vertical-align: middle; cursor: pointer; " title="link para o Arquivo da Anotação" ><span class="asteristico" >*</span>&nbsp;Arquivo (link):&nbsp;</label>
        </td  >
...
<select name="busca_proj" id="busca_proj"  title="Selecione o Projeto para Busca de Anota&ccedil;&otilde;es"  onchange="javascript: consulta_alteraranot(this.id, this.value,this.value);"  >
