...
//   Forca a recarregamento do site toda vez que o navegador entrar na p?gina
...
//
//  Cabecalho
require_once("{$_SESSION["incluir_arq"]}script/cabecalho_rge.php");
//
?>
</div>
<!-- Final Cabecalho -->
...
<?php 
///  Rodape
require_once("{$_SESSION["incluir_arq"]}includes/rodape_index.php"); 
///
?>
</div>
<!-- Final do  Rodape -->
