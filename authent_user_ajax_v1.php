...
*  
*   LAFB/SPFB250509.1736 - Correxoes gerais
*/
...
/***
          $msg_erro .= "Falha grave --- $regs  <b>{$_SESSION['user_cond']}</b> <br/>  $login_down  -->>  {$_SESSION["email_usuario"]}  <<-- reiniciar.".$msg_final;  
          echo  $msg_erro;
          exit();
    ****/
...
echo "ERRO: authent_user_ajax/450 -->> PARTE 3 -->> SEM ACESSO  \$permit_pa -- \$stotal = $stotal ";
exit();
