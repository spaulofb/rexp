...
//
/*************************************************************************/
//     DEFININDO A PASTA PRINCIPAL - alterado em 20250514
...
require_once("detectar_mobile.php"); 
...
// alert("LINHA/174 -->> enviado =  "+enviado);
...
/**  Final - function iniciar(enviado) {  */
//
...
function dochange(ativar,m_onload)  {
  ...
  //  alert(" ativar = "+ativar+"  -->>  m_onload = "+m_onload);
   ...
   /** Final - if( ativar.toUpperCase()=="SAIR" ) { */
   //
}
/**  Final - function dochange(ativar,m_onload)  {  */
//
//  Conectando
function conectando() {
      //
...
<?php
//
require_once("{$_SESSION["incluir_arq"]}includes/menu_horizontal_index.php");
//
?>
<!-- Final do MENU  -->
<!-- CORPO -->
