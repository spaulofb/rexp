...
if( intval($m_linhas)<1 ) exit();
///
///   Definindo a Raiz do Projeto  --  desativado em 20171023
...
<META HTTP-EQUIV="REFRESH"  CONTENT="1200,URL=http://www-gen.fmrp.usp.br/rexp/authent_user.php"> 
...
function ativando_dados(source,val,string_array) {
 ...
 //  alert(" LINHA 6 -source = "+source+"  - val = "+val+" - string_array = "+string_array)
...
//  alert("LINHA 122 source = "+source+" - val = "+val+" -  campo_nome =  "+campo_nome+" - campo_value =  "+campo_value)
    ...
    */
    ...
    //  alert(" ativar_orientador.php/242  -  source_upper = "+source_upper+" - val = "+val+" \r\n m_dados_recebidos = "+m_dados_recebidos)
                               document.getElementById('label_msg_erro').style.display="none";    
                               if( source_upper=="SUBMETER" ) {                              
 ...
 <table class="table_inicio" cols="<?php echo $_SESSION["cols"];?>" align="center"   cellpadding="1"  cellspacing="1" style="font-weight:normal;color: #000000; width: 100%; border: none;"  >
      <tr style="margin: 0px; padding: 0px; line-height: 10px; "  >
         ...
         <tr>
	       ...
	       <td  class="td_inicio1" style="vertical-align: middle; text-align: left;padding-right: 7px;" colspan="2"  >
              <label for="nome" style="vertical-align:bottom; padding-bottom: 1px;cursor: pointer;" title="Nome"   >Nome:&nbsp;</label>
			   <br /><br />
			  <input type="text" name="nome"   id="nome"   size="85"  maxlength="64"  value="<?php echo $nome;?>" readonly="readonly" />
        ...
        <tr align="left"  >
         <td  class="td_inicio1" style="text-align: left; vertical-align: middle; " colspan="<?php echo $_SESSION["cols"];?>" >
          ...
          <span class="td_informacao2"  >
              ...
              <input type="text" name="categoria"   id="categoria"  style="width: 260px;"  value="<?php echo $descr_categ;?>" readonly="readonly" />             
             </span>
              <!--  FINAL - Categoria  -->
              </td>
              </tr>
	   ...
	   <td    class="td_inicio1" style="border: 1px solid #000000;text-align: left;margin: 0px; padding: 0px;"  colspan="<?php echo $_SESSION["cols"];?>"  >
	      <table style="border: none; text-align: left;margin: 0px; padding: 0px;"  >
	       ...
	       <td  class="td_instituicao" style="vertical-align: middle; text-align: left;padding-right: 7px;"  >
            ...
            <label for="instituicao"  style="vertical-align:bottom; padding-bottom: 1px; cursor:pointer;" title="Institui&ccedil;&atilde;o"   >Institui&ccedil;&atilde;o:</label>
			   <br /><br />
               <input type="text" name="instituicao"  size="14" id="instituicao"  value="<?php echo $instituicao;?>" readonly="readonly" />             
               </span>
                  ...
                  ?>
                   <td  class="td_instituicao" style='position: relative; float: left; vertical-align: middle; text-align: left;padding-right: 7px;'  >
                     ...
                     <span class="td_informacao2"  >
                      ...
                      <br /><br />
                      <input type="text" name="unidade"  size="13" id="unidade"  value="<?php echo $unidade;?>" readonly="readonly" />             
                    </span>
                    <!--  Final da unidade  -->
                  </td>                  
                  <?php
                  if( strlen(trim($depto))>=1  ) {
                     ...
                     <td  class="td_instituicao" style='position: relative; float: left; vertical-align: middle; text-align: left;padding-right: 7px;'  >
                        ...
                        <span class="td_informacao2"  >
                          ...
                          <br /><br />
                          <input type="text" name="depto"  size="10" id="depto"  value="<?php echo $depto;?>" readonly="readonly" />             
                        </span>
                        <!--  Final do depto  -->
                        </td>                  
                     <?php                      
                  ...
                  if( strlen(trim($setor))>=1  ) {
                     ...
                     <td  class="td_instituicao" style='position: relative; float: left; vertical-align: middle; text-align: left;padding-right: 7px;'  >
                        ...
                        <span class="td_informacao2"  >
                          ...
                          <br /><br />
                          <input type="text" name="setor" id="setor"  size="10"   value="<?php echo $setor;?>" readonly="readonly" />             
                        </span>
                        <!--  Final do setor  -->
                        </td>                  
                     <?php                      
	    ...
	    <tr align="center"  >
            <!--  Usuario/Login para conectar -->
         <td  class="td_inicio1" style="text-align: center; vertical-align: middle; "  colspan="<?php echo $_SESSION["cols"];?>"   >
             <label for="login" style="vertical-align: middle; cursor: pointer;" title="Código do Usuário (Login)"   >Usu&aacute;rio (Login):&nbsp;</label>
                <input type="text" name="login"   id="login"   size="22"  value="<?php echo $login;?>"  />
            </td>
          <!-- Final - Usuario/login -->
       </tr>
      ...
      <tr style="margin: 0px; padding: 0px; line-height: 10px; "  >
	   <td  class="td_inicio1" style="border: 1px solid #000000; text-align: left;margin: 0px; padding: 0px;"  colspan="<?php echo $_SESSION["cols"];?>"  >
          ...
          <!--  EMAIL -->
	       <td  class="td_inicio1" style="border: none; vertical-align: middle; text-align: left;padding-right: 7px;" colspan="1"  >
              <label for="e_mail" style="vertical-align:bottom; padding-bottom: 1px;cursor: pointer;" title="E_MAIL"   >E_MAIL:&nbsp;</label>
			   <br /><br />
			  <input type="text" name="e_mail" id="e_mail" size="80" value="<?php echo $e_mail;?>" />
               <!-- Final - EMAIL -->
			 </td>
        <td  class="td_inicio1" style="vertical-align: middle; text-align: left;padding-right: 7px;" colspan="1"  >
          <!-- Telefone - digitar -->
	    ...
	    <td  class="td_inicio1" style=" vertical-align: middle; text-align: left;padding-right: 7px;" colspan="1"  >
	       ...
	       <br /><br />
	        <input type="text" name="ramal" id="ramal" size="14"  value="<?php echo $ramal;?>" />
			<!-- Final - ramal -->
               <!-- PA do Orientador -->
           ...
           <tr align="center" style="border: none; vertical-align:top; line-height: 0px;" >
             <td colspan="<?php echo $_SESSION["cols"];?>" style="border: 1px solid #000000; padding: 1px; text-align:center; line-height:0px;" align="CENTER" nowrap >
              ...
              <td     nowrap style="padding-left: 0px; vertical-align: middle; text-align: left; border: none; " >
                <!-- NAO -->                  
			   <button type="submit" name="nao" id="nao"  class="botao3d" style="cursor: pointer;" title="N?o" acesskey="N" alt="N?o"  onclick="javascript: ativando_dados('submeter','orientador_novo#nao',document.form1); return false;" >    
                 N?o&nbsp;&nbsp;<img src="imagens/limpar.gif" alt="N?o" style="vertical-align:text-bottom;" >
               </button>
               <!-- Final - NAO -->
		      </td>
			   </tr>
