...
<section class="section_inicio" >
   <article  class="article_inicio"  >
       <div class="usuario_senha"  >    
          <!--  Digitar  Usuario/EMail/Codigo USP    -->
             <label for="userid" class="label_campos" title="Digitar email" >
              ...
              <input type="email" name="userid"  id="userid" style="width: 300px;"  maxlength="60" 
               required="required"  onkeypress="myFunction()" 
                onfocus="javascript: id_conteudo('liga','Digitar email/Código USP');" 
                placeholder="nome@email.com ou Código USP"  autocomplete="off"  tabindex="1" 
                 autofocus="autofocus"  title="Digitar email/Código USP"  />
            ...
            <div class="usuario_senha" >    
               ...
               <label for="userpassword" class="label_campos" ><span>Senha:</span></label>
                 ...
                 <label for="userpassword" class="label_campos" >
                     <img src="imagens/olho_fechado_14pixels.png" id="olho" alt="Clicar" class="olho" title="Clicar" onclick="show(this.id,'userpassword')" >
                 </label>
              <!-- Final - Digitar Senha -->       
          </div>    
     </article>   
         ...
         <div class="limpar_enviar"  >
            <!-- RESET/SUBMIT -->
              ...
              <input type="submit"  name="enviar"  id="enviar" class="botao3d"  style="width: auto; font-size: small;"  acesskey="E"  value="Enviar"  tabindex="4"  alt="Enviar"  
                       onclick="doaction('SUBMIT'); return false;"  title="Enviar"  />                  
           </div>
           <div id="conteudo" ></div> 
