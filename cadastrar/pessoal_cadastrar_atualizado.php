 ...
 <div class="parte_inicial"  >
      ...
      <input type="text" name="fone"  id="fone" maxlength="14" onKeyDown="Mascara(this,Telefone);" 
       onKeyPress="Mascara(this,Telefone);" onKeyUp="Mascara(this,Telefone);" 
         placeholder="(xx) xxxx-xxxx"  pattern="\([0-9]{2}\)[\s][0-9]{4}-[0-9]{4,5}"  style="padding:1px;"  onblur="javascript: exoc('label_msg_erro',0,'');" 
          title="Digitar telefone somente n&uacute;mero incluindo dd" >
            <!-- Final - Telefone -->                       
             </td>
             <td>
      <input type="number" name="ramal" min="1"   id="ramal"   size="12"  maxlength="10" onKeyUp="this.value=trim(this.value);" 
        onblur="javascript: alinhar_texto(this.id,this.value)" autocomplete="off"  style="cursor: pointer;"  />
               <!-- Final - Ramal -->                           
             </td>
           </tr>
