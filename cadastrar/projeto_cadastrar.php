...
/**  
 echo "ERRO: linha106 -->> REQUEST_METHOD  -->>  ANTES do functions.php   ";
 exit();        
      */           
...
/**  
 echo "ERRO: linha139 -->> REQUEST_METHOD  -->>   \$conta_arquivos = $conta_arquivos  ";
 exit();        
      */
...
/**  
  echo "LINHA191 -->> REQUEST_METHOD  -->>  \$max_file_size = $max_file_size  <<-->>  \$tamanho_dir[0] = "
     .$tamanho_dir[0]." <br> \$tipo_tamanho = $tipo_tamanho -->> \$espaco_em_disco = $espaco_em_disco ";
  exit();            
   */
 ...
 /**  
echo "LINHA279 -->> REQUEST_METHOD  -->>  \$lcdir = $lcdir  <<-- "
     ." <br> \$filename = $filename  -->> \$espaco_em_disco = $espaco_em_disco ";
  exit();            
       */            
...
//  
require_once("{$_SESSION["incluir_arq"]}js/projeto_cadastrar_js.php");
//
...
<?php
    if( strlen(trim($_SESSION["erros"]))<1 ) {
           $_SESSION["display_arq"]='none';
    } 
}       
//
...
if( isset($_SESSION["onsubmit_tabela"])  ) {
    $onsubmit_tabela = $_SESSION["onsubmit_tabela"];
}
//
?>        
         ...
         <!-- Relatorio Externo (link) Projeto -->
          <td  class="td_inicio1" style="vertical-align: middle; "  colspan="1" >
           ...
           <td class="td_inicio2" style="vertical-align: middle; " colspan="1"  >
               ...
               <input type="file" name="relatproj"  id="relatproj"  size="90"  accept="application/pdf" 
       ...
       <td  align="center"  style="text-align: center; border:none;" colspan="2" >
         <button  type="submit" name="enviar_arq" id="enviar_arq" class="botao3d" 
            style="width: 160px; cursor: pointer;" title="Enviar"  acesskey="E"  alt="Enviar" 
               onclick="if( trim(document.getElementById('relatproj').value)=='' ) { alert('Importante: informar o arquivo do Projeto.'); document.getElementById('relatproj').focus(); return false; } " >
   ...
   <form name="form1" id="form1"  method="post" enctype="multipart/form-data" style="height: auto;"  >
      ...
      <div class="parte_inicial"  >
        ...
        <div class="div_nova" >
           ...
           <span>    
               <textarea rows="3" name="titulo" id="titulo"  value="" 
                    onKeyPress="exoc('label_msg_erro',0,'');limita_textarea('titulo');" 
      ...
      <div class="div_nova" >
       ...
       <!-- Numero de Coautores -->
        ...
        <input type="number" name="coresponsaveis" id="coresponsaveis" min="0"
           ...
           onKeyup="javascript: n_coresponsaveis(this,event); "  value="0" 
            style="padding: 1px; font-weight: bold;" 
            onblur="javascript: if( this.value<1 ) exoc('incluindo_coresponsaveis',0);" />
            &nbsp;
        <input  type="button"  onclick="enviar_dados_cad('coresponsaveis');"  id="busca_coresponsaveis" 
           ...
           <!-- Limpar campos -->                  
            <span>
               <button type="button"  name="limpar" id="limpar" class="botao3d"  
                    onclick="javascript: enviar_dados_cad('reset','reiniciar'); return false;"  
