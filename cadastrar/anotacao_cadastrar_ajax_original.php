...
if( $source_upper=="ANOTACAO" ) { ////  IF  - Tabela ANOTACAO 
    ...
    if( strtoupper(trim($val))=="PROJETO" ) {
           ...
           $result_anotacao=mysql_query("SELECT  a.anotacao,a.cip,a.numprojeto,b.nome as projeto_autor_nome "
...
if( strtoupper($val)=="ANOTACAO" ) {
	...
	$result_anot=mysql_query("SELECT  anotacao,autor as projeto_autor FROM $bd_2.projeto  WHERE cip=$projeto  ");
    ///
    if( ! $result_anot ) {
