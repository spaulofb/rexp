 ...
 */
 ...
 echo  " anotacao_cadastrar_ajax/848 -- \$source_upper = $source_upper   -- strtoupper(val)==ANOTACAO   -- \$m_array = $m_array  <br/>"
        ."   \$campos_nome = $campos_nome <br/>
      \$campos_valor =  $campos_valor  -->>  PASSOU";
 ...
 exit();    
    ...
    if( $success ) { 
        ...
        $msg_erro .="&nbsp;Anota&ccedil;&atilde;o <b>N&Atilde;O</b> foi cadastrada. Insert anotacao " .mysqli_error().$msg_final;
        mysqli_query('rollback'); 
        echo $msg_erro;         
    }
