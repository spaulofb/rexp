...
if( isset($_POST['fileframe']) ) {
  ...
  if( isset($_FILES['relatext']['tmp_name']) ) {
	...
	for( $n=1; $n<3 ; $n++ ) {                
       ...
       if( intval($n)==1 )  $_SESSION["dir"] = "/var/www/html".$_SESSION["pr_relatanot"]."doctos_img/A".$projeto_autor;
    ...
    <tr>
     <!-- Relatorio Externo (link) Projeto -->
      <td class="td_inicio1" style="vertical-align: middle;"  colspan="1" >
		...
		<td class="td_inicio2" style="vertical-align: middle;" colspan="1"  >
           ...
           <input type="file" name="relatext"  id="relatext"  size="90" title="Relatório Externo da Anotação (link)" required="required"  style="cursor: pointer; vertical-align:middle; " onChange="javascript: jsUpload(this);"  />
     ...
     <tr>
      <!--  Aviso na espera do processo -->
       <td id="aguarde_arq" style="text-align: center; border: 3px double #000000; width:100%;width:100%;"  colspan="3" >
            Aguarde. Esse processo pode demorar...   
       </td>
      <!-- Final - Aviso na espera do processo -->          
    </tr>    
    <tr class="td_inicio1" >
      <!--  Enviar Relatorio/Arquivo Anotacao  -->
      <td align="center" style="text-align: center; width: 100%;"  colspan="2" >
		 <button name="enviar_arq" id="enviar_arq"   type="submit"  class="botao3d" 
           style="width: 160px; cursor: pointer;"   title="Enviar"  acesskey="E"  alt="Enviar"   onclick="javascript: if(  trim(document.getElementById('relatext').value)=='' ) { document.getElementById('relatext').focus(); return false; } "     >    
         Enviar arquivo&nbsp;<img src="../imagens/enviar.gif" alt="Enviar Arquivo"  style="vertical-align:text-bottom;"  >
         </button>
	  </td>
	</tr>		  
    <tr>
       <td  style="display:block; text-align: left; color: #000000;;"   colspan="2" >
          <span class="asteristico" >*</span>&nbsp;<b>Campo obrigat&oacute;rio</b>    
       </td>
     <!-- Final - Enviar Relatorio/Arquivo Anotacao  -->             
    </tr>         
</table>
</form>
...
<form name="form1" id="form1"  enctype="multipart/form-data"  method="post"  
 onsubmit="javascript: enviar_dados_cad('submeter','ANOTACAO',document.form1); return false"  >
    <section>
      <article class="anotacaoarticle1" style="font-size:x-small;" >
        <h3>
            ...
            <?php 
               ...
               if( ! $res_anotador ) {
                ...
                /// Final da Num_USP/Nome Autor/Anotador 
                 ...
                 ////
           ?>  
           <input type="hidden" name="autor" id="autor" size="70" maxlength="86"  
    ...
    <section>
      <article class="anotacaoarticle1" style="font-size: x-small;" >
        <label class="tit_anotacao"  style="vertical-align: middle; cursor: pointer; color: #000000;">
            <span class="asteristico" style="vertical-align: middle;" >*</span>
            Projeto:&nbsp;</label>
       ...
       <select name="projeto"  id="projeto"  required="required"  title="Identificação do Projeto" 
         onchange="javascript:  enviar_dados_cad('anotacao',this.id,this.value)" 
          style="font-size: 1em; padding: 1px 0 1px 0;">                   
    <?php
        ...
        <div id="tr_projeto_autor_nome" class="td_inicio1" style="display: none; vertical-align: middle; text-align: justify;  margin: 0px; border: none;"  >
            <label class="tit_anotacao" style="font-weight: normal;"  >Orientador desse Projeto:&nbsp;</label>
    ...
    <section>
      <article class="anotacaoarticle1" >
        <table class="table_inicio" style="margin: 0px;font-size:x-small;" >
            <tr class="td_inicio1"  >
              <!--  Nr. Anotacao -->      
              <td style="vertical-align: middle; background-color:#FFFFFF; color:#000000;" >Anota&ccedil;&atilde;o#
              </td>
             <td id="nr_anotacao"  class="td_inicio1" 
  ...
  <section>
    <article class="anotacaoarticle1"  >
      <!--  Titulo Anotacao -->
      <div>
        <label for="titulo"  class="tit_anotacao"  style="vertical-align: middle; font-size:x-small;"  title="T&iacute;tulo da Anota&ccedil;&atilde;o" >
             <span class="asteristico" style="vertical-align: top;" >*</span>&nbsp;T&iacute;tulo da Anota&ccedil;&atilde;o:&nbsp;
        </label>
        <br/>
        <textarea rows="4" cols="64"  name="titulo" id="titulo" $result_pessoa 
     ...
     <div style="height: 1.6em; font-size: x-small; display: flex; margin: 0px;" >
       <span id="sn_altera_complementa" class="td_inicio1"  
        style="border: none; display: none;padding:4px 2px 0px 4px;overflow:hidden; " colspan="<?php echo $cols/2;?>"  >
       </span>
       <span  id="td_altera_complementa" class="td_inicio1" 
        style="font-size: x-small; border: none; display: none; padding:6px 2px 0px 4px; overflow:hidden; "  colspan="<?php echo $cols/2;?>" >
       </span>
  ...
  <section style="margin-top: 0px;" >
    <article class="anotacaoarticle1"   >
      ...
      <label for="testemunha1"  style="vertical-align:bottom; cursor: pointer;font-size:x-small;"  title="Código da Testemunha (1) da realização " >
         Testemunha (1):&nbsp;</label>
      <br />
      ...
      <label for="testemunha2"  style="vertical-align:top;font-size:x-small; cursor: pointer; padding-top: 4px; padding-bottom: 4px;"  title="Código da Testemunha (2) da realização "  >
            Testemunha (2):&nbsp;</label>
      <br />
        ...
        ?>
        <select style="font-size:x-small;"  name="testemunha2" id="testemunha2" class="td_select" title="Código da Testemunha (2) da realização" >
        <?php
               ////  Código da Testemunha (2) da realização 
   ...
   <section> 
      <!--  TAGS  type reset e  submit  -->                                              
       <article class="projetoarticlexy"  style="width: 100%;" >
          <!-- Limpar campos -->                  
