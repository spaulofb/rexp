<?php 
/**
*    ANOTADOR - ANOTACAO CADASTRAR NOVA - 20181019
*/
...
echo "anotacao_cadastrar_nova/237   -- AQUI --- CONTINUAR  ";
...
<script type="text/javascript"  src="<?php echo $host_pasta;?>js/anotacao_cadastrar_nova.js" ></script>
<?php
