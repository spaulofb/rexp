...
/**                 
   ...
   */
          ...
          onchange="enviar_dados_cad('CONJUNTO',this.value,this.name+'|'+'<?php echo $vars_ambiente;?>'+'|'+'<?php echo $nmcpopri;?>');"  
            style="padding: 1px;" title="Institui&ccedil;&atilde;o" required="required"  >            
               <?php
                  //
                  //  INSTITUICAO
                 //
      ...
      <input type="text" name="fone"  id="fone"  class="telefone" 
           ...
           title="Digitar telefone somente n&uacute;mero incluindo dd" >
            <!-- Final - Telefone -->                       
             ...
             <td>
              <!-- Ramal - digitar -->
          <input type="number" name="ramal" id="ramal"  class="ramal" 
             maxlength="4"  onKeyUp="this.value=trim(this.value);" 
            onblur="xramal(this.id,this.value)" title="Digitar somente 4 números no Ramal"  
              autocomplete="off"  pattern="[0-9]{4}"  />
               <!-- Final - Ramal -->                           
             </td>
           </tr>
